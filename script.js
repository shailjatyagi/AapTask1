$(function() {  
  $('#clickme').click(function() {
    ...
    d+='<tr><th style="padding:100px">S. No.</th><th>Username</th><th>Follower Count</th><th>Likes Ratio</th><th>Comments Ratio</th><th>Picture</th></tr>';

		 for(var i=0;i<items.length;i++){
      // console.log([i]+items[i]);   
      // console.log([i]+items[i].picture.status);   

      d+='<tr><td style="padding:100px">'+ (i+1) + '</td>' + '<td>' + items[i].username+'</td>'+
